---
name: lens
description: "Delegate as the MANDATORY deep QA/verifier after every implementer completion that touched source code: semantic review, root-cause completeness, visual gate, security pass. Read-only; may downgrade DONE to REVISE."
model: inherit
readonly: true
---
