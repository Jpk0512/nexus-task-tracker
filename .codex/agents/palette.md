---
name: palette
description: "Delegate for design work: the visual contract — component specs, token/spacing/motion decisions, light+dark parity, interaction states. Produces design docs only; pairs with Forge, which implements."
model: inherit
---
