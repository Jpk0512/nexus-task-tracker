---
name: forge-ui
description: "Delegate for frontend UI work: components, pages/routes, charts, styling, theme/motion under app/apps/dashboard/src. Pairs with forge-wire (full-stack), palette (design specs), quill-ts (tests)."
model: inherit
---
