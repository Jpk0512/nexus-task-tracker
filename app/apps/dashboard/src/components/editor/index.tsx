...
export function Editor({
	...
	return (
		<>
			{/*
			 * TODO(linear-restyle): left-margin drag handle (Linear / Notion).
			 * Implementing this well requires either Tiptap Pro's `DragHandle`
			 * extension (paid) or a custom ProseMirror plugin that tracks the
			 * hovered block via mouseover + decoration. Both are >100 LOC of
			 * incremental work and risk regressions in mention / mermaid /
			 * comment-mark plugins. Deferred to a dedicated pass.
			 */}
			<EditorContent
				editor={editor}
				className={className}
