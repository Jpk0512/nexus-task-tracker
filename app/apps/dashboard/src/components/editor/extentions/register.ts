...
import { PromptMentionExtension } from "./mentions/prompt-mention";
...
const extensions = ({
	...
	// Iter4 — slash-menu entity-link pills (knowledge notes, saved prompts).
	// Inserted via slash menu, not the unified @ trigger (kept off the global
	// dropdown intentionally — too noisy when typing @ for a person).
	KnowledgeMentionExtension,
